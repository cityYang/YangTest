...
public class HttpClientTest {
	...
	private static String appKey = "chexiangpei";
	private static String securityKey = "NzSND7MS";
	private static String timestamp = format.format(new Date());
	private static String service = "MDMCarLib.ly.MDMLyService";
	private static String method = "findCxpLibrary";
	// private static String httpUrl = "http://openapi.chexiang.com/services/" +
	// service + "/" + method;
	// private static String httpUrl =
	// "http://openapi.pre.chexiang.com/services/" + service + "/" + method;
	private static String httpUrl = "http://openapi.sit.chexiang.com/services/" + service + "/" + method;
	// private static String httpUrl = "http://127.0.0.1:8080/services/" +
	// service + "/" + method;

	@SuppressWarnings("deprecation")
	public static void main(String[] args) {
			String message = "{\"startrq\":\"2017-01-17\",\"endrq\":\"2017-01-17\",\"page\":{ \"pagesize\":100, \"currentPage\": "+1+"}}";
	...
	public static String makeOriginalString(Map<String, String> headParams, String service, String method,
			String message, String securityKey) {
